...
std::pair<uint64_t, uint8_t> O3_CPU::btb_bbtbDbasic_btb_predict(uint64_t ip, uint8_t branch_type)
{
...
void O3_CPU::btb_bbtbDbasic_btb_update(uint64_t ip, uint64_t branch_target, uint8_t taken, uint8_t branch_type)
{
